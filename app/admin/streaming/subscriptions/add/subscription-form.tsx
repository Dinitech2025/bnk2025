    ...
    try {
      ...
      switch(offer.durationUnit) {
        ...
        case 'WEEK':
          ...
          break;
        case 'MONTH':
          endDate = addMonths(startDate, offer.duration);
          break;
        case 'YEAR':
          endDate = addYears(startDate, offer.duration);
          break;
        default:
          endDate = addDays(startDate, offer.duration);
          break;
  ...
  const calculateDates = () => {
    ...
    switch(selectedOffer.durationUnit) {
      ...
      case 'WEEK':
        ...
        break;
      case 'MONTH':
        endDate = addMonths(startDate, selectedOffer.duration);
        break;
      case 'YEAR':
        endDate = addYears(startDate, selectedOffer.duration);
        break;
      default:
        endDate = addDays(startDate, selectedOffer.duration);
        break;
